...
public class PatchClientTest {
    ...
    public void testPatch() {
        ...
        toPatch.setDynamicClientRegistrationEnabled(false);
        ...
        patcher.setDynamicClientRegistrationEnabled(Optional.of(true));
        ...
        assertTrue(result.isDynamicClientRegistrationEnabled());
