...
public class ClientServiceTest {
    ...
    public void shouldCreate() {
        ...
        when(grantTypeService.completeGrantTypeCorrespondance(any())).thenReturn(createClient);
    ...
    @Test
    public void shouldCreate_generateUuidAsClientId() {
        Client createClient = Mockito.mock(Client.class);
        ...
        TestObserver testObserver = clientService.create(DOMAIN, new Client()).test();
        testObserver.awaitTerminalEvent();
    ...
    @Test
    public void validateClientMetadata_dynamicClientRegistrationException() {
        UpdateClient updateClient = Mockito.mock(UpdateClient.class);
