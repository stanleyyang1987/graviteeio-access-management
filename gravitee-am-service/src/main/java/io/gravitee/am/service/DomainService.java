...
public interface DomainService {
    ...
    boolean isDynamicClientRegistrationEnabled(Domain domain);

    boolean isRedirectUriLocalhostAllowed(Domain domain);

    boolean isRedirectUriUnsecuredHttpSchemeAllowed(Domain domain);

    boolean isRedirectUriWildcardAllowed(Domain domain);
}
