...
public interface ClientAssertionAuthHandler {
     ...
     */
    static AuthHandler create(AuthProvider authProvider, ClientAssertionService clientAssertionService) {
        return AuthHandler.newInstance(new ClientAssertionAuthHandlerImpl(authProvider, clientAssertionService));
    }
}
