 ...
 */
public class ResetPasswordSubmissionRequestParseHandler implements Handler<RoutingContext> {

    private static final Logger logger = LoggerFactory.getLogger(ResetPasswordSubmissionRequestParseHandler.class);
