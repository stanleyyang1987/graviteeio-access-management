...
public class UserInfoRequestParseHandler implements Handler<RoutingContext> {
    ...
    public void handle(RoutingContext context) {
        ...
        this.tokenService.extractAccessToken(context, true)
    ...
    private Maybe<Token> isValid(Token accessToken) {
        ...
        if (accessToken.getScope() == null || !Arrays.asList(accessToken.getScope().split("\\s+")).contains(Scope.OPENID.getName())) {
