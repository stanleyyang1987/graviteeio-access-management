 ...
 */
public class RegistrationConfirmationEndpointHandler implements Handler<RoutingContext> {

    private static final Logger logger = LoggerFactory.getLogger(RegistrationConfirmationEndpointHandler.class);
    private static final String ERROR_PARAM = "error";
    private static final String SUCCESS_PARAM = "success";
    private static final String TOKEN_PARAM = "token";
    private ThymeleafTemplateEngine engine;

    public RegistrationConfirmationEndpointHandler(ThymeleafTemplateEngine thymeleafTemplateEngine) {
